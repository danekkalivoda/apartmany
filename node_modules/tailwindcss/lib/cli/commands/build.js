...
function buildToFile(compileOptions, startTime) {
  utils.header();
  utils.log();
  utils.log(emoji.go, 'Building...', _chalk.default.bold.cyan(compileOptions.inputFile));
  return (0, _compile.default)(compileOptions).then(result => {
    ...
    utils.log();
    utils.log(emoji.yes, 'Finished in', _chalk.default.bold.magenta(prettyTime));
    utils.log(emoji.pack, 'Size:', _chalk.default.bold.magenta((0, _bytes.default)(result.css.length)));
    utils.log(emoji.disk, 'Saved to', _chalk.default.bold.cyan(compileOptions.outputFile));
    utils.footer();
  });
}
/**
...
function run(cliParams, cliOptions) {
  return new Promise((resolve, reject) => {
    ...
    !utils.exists(inputFile) && stop(_chalk.default.bold.magenta(inputFile), 'does not exist.');
    configFile && !utils.exists(configFile) && stop(_chalk.default.bold.magenta(configFile), 'does not exist.');
