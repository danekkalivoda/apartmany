...
function forApp() {
  ...
  utils.log();
  utils.log('Usage:');
  utils.log('  ', _chalk.default.bold(constants.cli + ' <command> [options]'));
  utils.log();
  utils.log('Commands:');
  (0, _lodash.forEach)(_.default, command => {
    utils.log('  ', _chalk.default.bold((0, _lodash.padEnd)(command.usage, pad)), command.description);
  });
}
/**
...
function forCommand(command) {
  utils.log();
  utils.log('Usage:');
  utils.log('  ', _chalk.default.bold(constants.cli, command.usage));
  utils.log();
  utils.log('Description:');
  utils.log('  ', _chalk.default.bold(command.description));
  ...
  if (command.options) {
    ...
    (0, _lodash.forEach)(command.options, option => {
      utils.log('  ', _chalk.default.bold((0, _lodash.padEnd)(option.usage, pad)), option.description);
    });
  }
}
/**
...
function invalidCommand(commandName) {
  utils.error('Invalid command:', _chalk.default.bold.magenta(commandName));
  forApp();
  utils.die();
}
/**
